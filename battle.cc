...
int battle::AttackHandler(Map::Territory *attacking, Map::Territory *defending){
...
int battle::AutoAttack(Map::Territory *attacking, Map::Territory *defending){
...
void battle::SingleAttack(Map::Territory *attacking, Map::Territory *defending){
...
void battle::Capture(Map::Territory* attacking, Map::Territory* defending){
...
void battle::Retreat(Map::Territory* attacking, int result){
	if (result = 2)
...
int battle::DetermineAtkDice(Map::Territory* attacking){
	if (attacking->get_num_units() < 3)
		return attacking->get_num_units() - 1;
	else return 3;
}

int battle::DetermineDefDice(Map::Territory* defending){
	if (defending->get_num_units() < 2)
		return 1;
	else return 2;
}

// move this baby to Map::Territory, it belongs there
void battle::DecrementUnits(Map::Territory* territory){
