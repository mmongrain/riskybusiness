default: ui.cc gui.cc random_ai_player.cc defensive_ai_player.cc aggressive_ai_player.cc strategy.cc battle.cc comp_player.cc game.cc game_driver.cc human_player.cc map.cc observer.cc player.cc
	g++ game_driver.cc random_ai_player.cc defensive_ai_player.cc aggressive_ai_player.cc strategy.cc exceptions.cc gui.cc ui.cc card.cc deck.cc stats_basic.cc stats_battle.cc stats_control.cc continent.cc territory.cc battle.cc game.cc human_player.cc map.cc observer.cc player.cc player_view.cc -std=c++11 -lsfml-graphics -lsfml-window -lsfml-system -Wall -Wextra -o a.o
...
cards: territory.cc continent.cc battle.cc comp_player.cc game.cc gui_main.cc human_player.cc map.cc observer.cc player.cc
	g++ cards_main.cc card.cc deck.cc stats.cc stats_basic.cc stats_battle.cc stats_control.cc continent.cc territory.cc battle.cc comp_player.cc game.cc human_player.cc map.cc observer.cc player.cc strategy_defensive.cc strategy_aggressive.cc strategy_random.cc player_view.cc -std=c++11 -lsfml-graphics -lsfml-window -lsfml-system -o cards.o
